...
<WorkImage
  ...
  caption="Dify · 高质量索引(语义):召回结果与 Coze 对齐。 / Dify · high-quality index (semantic): recall aligns with Coze."
  placeholder={false}
/>
...
<WorkImage
  ...
  caption="step5_rag.py 的核心 LCEL 链路——检索、Prompt 组装与生成显式串成一条链，每一步取舍可见。 / The core LCEL chain in step5_rag.py — retrieval, prompt assembly, and generation wired explicitly into one chain, every decision visible."
  placeholder={false}
/>
