...
<WorkImage
  src="/works/fire-code-rag/kb-segments.jpg"
...
<WorkImage
  src="/works/fire-code-rag/langchain-repo.jpg"
  caption="GitHub 仓库首页。 / The GitHub repository homepage."
  placeholder
/>

<WorkImage
  src="/works/fire-code-rag/langchain-code.jpg"
  caption="step5_rag.py 的核心 LCEL 链路代码。 / The core LCEL pipeline in step5_rag.py."
  placeholder
/>

<WorkImage
  src="/works/fire-code-rag/langchain-test.jpg"
