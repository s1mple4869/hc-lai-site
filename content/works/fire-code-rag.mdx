...
展开下方查看这一版的完整记录：GitHub 仓库、逐条关键工程决策，以及正向 / 超纲两组测试的原始输出。

Expand the case below for the full build — the GitHub repo, each key engineering decision, and the raw output of both tests.
