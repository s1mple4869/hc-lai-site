...
<WorkImage
  src="/works/job-decision/csv-log.png"
...
The structural reality that application feedback is slow and sparse (a platform-display + hiring-market issue, not a tooling one), reply rate itself (data still accumulating), interview conversion and offer quality (longer feedback loop).
