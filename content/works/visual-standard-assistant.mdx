...
<WorkImage
  ...
  caption="Dify 双模式工作流全景:以「有无上传图片」分流为判图 / 问答两条路径,两条路径判断前必过知识库;判图路径先观察、后判断,视觉分析与判定分离。 / The Dify workflow branches on image upload into judge-image and Q&A paths; both must pass through the knowledge base before any verdict, and the judge-image path separates observation from judgment."
